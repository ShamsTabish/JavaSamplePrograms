...
import quickSort.TStack.StackNode;
...
public class BinaryTree {
	...
	public void dfsPreOrderIterative(TreeNode node) {
		TStack<TreeNode> stack = new TStack<TreeNode>();
		stack.push(node);
		while (!stack.isEmpty()) {
			node = stack.pop();
			System.out.print("  " + node.getData());
	...
	public void dfsInorderIterative(TreeNode node) {
	...
	public static void main(String[] args) {
		...
		//tree.dfsPreOrderIterative(tree.root);
		 tree.dfsInOrder(tree.root);
		 System.out.println();
		 tree.dfsInorderIterative(tree.root);
