...
public class ThreadClassExmple {
	...
	public static void main(String[] args) {
		...
		tableFor2.setName("T2");
		tableFor3.setName("T3");
		tableFor4.setName("T4");
		tableFor5.setName("T5");
		tableFor6.setName("T6");
...
class TableCalculator extends Thread{
	...
	public void run() {
		...
		for(int i=1;i<=10; i++){
			...
			System.out.println(tableFor+" Table value for "+i+" is "+number +" -- From "+getName());
			number+=tableFor;
		}
	}
